...
# Project:  libs.pro
# Template: subdirs
# Command: /usr/lib/qt/bin/qmake -o Makefile libs.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = libs1.0.0
DISTDIR = /home/dronte/cppdaemon/cppdaemon/.tmp/libs1.0.0
SUBTARGETS    =  \
		sub-cplusplus


sub-cplusplus-qmake_all:  FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile
	cd cplusplus/ && $(MAKE) -f Makefile qmake_all
sub-cplusplus: FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile
sub-cplusplus-make_first: FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile 
sub-cplusplus-all: FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile all
sub-cplusplus-clean: FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile clean
sub-cplusplus-distclean: FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile distclean
sub-cplusplus-install_subtargets: FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile install
sub-cplusplus-uninstall_subtargets: FORCE
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile uninstall

Makefile: libs.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
...
qmake_all: sub-cplusplus-qmake_all FORCE

make_first: sub-cplusplus-make_first FORCE
all: sub-cplusplus-all FORCE
clean: sub-cplusplus-clean FORCE
distclean: sub-cplusplus-distclean FORCE
	-$(DEL_FILE) Makefile
install_subtargets: sub-cplusplus-install_subtargets FORCE
uninstall_subtargets: sub-cplusplus-uninstall_subtargets FORCE

sub-cplusplus-check:
	@test -d cplusplus/ || mkdir -p cplusplus/
	cd cplusplus/ && ( test -e Makefile || $(QMAKE) /home/dronte/cppdaemon/cppdaemon/cplusplus/cplusplus.pro -o Makefile ) && $(MAKE) -f Makefile check
check: sub-cplusplus-check
