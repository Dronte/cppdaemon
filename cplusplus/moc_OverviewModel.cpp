...
struct qt_meta_stringdata_CPlusPlus__OverviewModel_t {
    QByteArrayData data[5];
    char stringdata[63];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CPlusPlus__OverviewModel_t, stringdata) + ofs \
...
void CPlusPlus::OverviewModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OverviewModel *_t = static_cast<OverviewModel *>(_o);
        switch (_id) {
        case 0: _t->rebuild((*reinterpret_cast< CPlusPlus::Document::Ptr(*)>(_a[1]))); break;
        default: ;
        }
    }
}
